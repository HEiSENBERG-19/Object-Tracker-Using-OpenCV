...
def draw_bounding_box_on_image(image,
                               ...
                               xmax,
                               color='red',
                               thickness=8,  # Increase this value to make the box thicker
                               display_str_list=(),
                               use_normalized_coordinates=True):
    ...
    Args:
      ...
      xmax: xmax of bounding box.
      color: color to draw bounding box. Default is red.
      thickness: line thickness. Default value is 8. Increase this to make the box thicker.
      display_str_list: list of strings to display in box
                        (each to be shown on its own line).
      use_normalized_coordinates: If True (default), treat coordinates
        ymin, xmin, ymax, xmax as relative to the image.  Otherwise treat
    ...
    if thickness > 0:
        draw.line([(left, top), (left, bottom), (right, bottom), (right, top),
                  ...
                  fill=color)
    try:
        font = ImageFont.truetype('arial.ttf', 36)  # Increase font size
    except IOError:
    ...
    for display_str in display_str_list[::-1]:
        ...
        draw.text(
            ...
            fill='black',
            font=font,
            stroke_width=1)  # Adjust stroke_width to make text less bold
